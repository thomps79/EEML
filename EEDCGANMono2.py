...
class PNGDataset(Dataset):
	def __init__(self, root_dir, im_size):
	...
	def __getitem__(self, idx):
		...
		image = self.data_transforms(self.image_files[idx])
...
def main():
	...
	png_dir = "C:\\Users\\awt24\\Downloads\\ArchivEE_1.0.0\\monochrome\\output\\"
	...
	"""datasets = []
	for i in range(1):
		datasets.append(dset.ImageFolder(root=png_dir,
	...
	dataset = PNGDataset(png_dir, image_size)
